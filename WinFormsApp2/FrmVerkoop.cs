...
namespace Groep_project_2
{
    public partial class FrmVerkoop : Form
    {
        ...
        Grondstof aardappel = new Grondstof("Aardappelen", 3000, 20); //TODO: Stock inladen via txt bestand (yorben)
        Grondstof kruiden = new Grondstof("Kruiden", 1000, 10);
        ...
        {
            listAanbod.Add(aardappel);
            listAanbod.Add(kruiden);
        }
            ...
            foreach (Grondstof vraag in listVraag)
            {
                foreach (Grondstof stock in listAanbod)
                {
                    if (stock.Naam == vraag.Naam)
                    {
                        ...
                        mijnLeveringsbon.Eenheidsprijs = stock.Prijs;
